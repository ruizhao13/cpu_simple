...
HD_PWD='D:/study/COD/lab/lab5/lab5/lab5.runs/data_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source data_mem.tcl
